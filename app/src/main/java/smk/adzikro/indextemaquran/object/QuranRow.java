...
public class QuranRow {
  ...
  public static class Builder {
    ...
    public Builder withAksi(int aksi) {
      mAksi = aksi;
      return this;
    }
    ...
    public QuranRow build() {
      return new QuranRow(mText, mMetadata, mRowType, mSura,
          ...
          mJuzOverlayText, mBookmarkId, mTagId, mBookmark, mAksi);
    }
  }
  ...
  private QuranRow(String text, String metadata, int rowType,
      ...
      Integer juzType, String juzOverlayText, long bookmarkId, long tagId, Bookmark bookmark, int aksi) {
    this.text = text;
