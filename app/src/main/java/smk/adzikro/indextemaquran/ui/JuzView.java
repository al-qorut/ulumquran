...
public class JuzView extends Drawable {
  ...
  public JuzView(Context context, int type, String overlayText) {
    ...
    final int circleColor = resources.getColor(R.color.colorPrimary);
    final int circleBackground = resources.getColor(R.color.colorPrimaryDark);
    ...
    if (!TextUtils.isEmpty(mOverlayText)) {
      final int textColor = resources.getColor(R.color.primary_text);
      final int textSize =
